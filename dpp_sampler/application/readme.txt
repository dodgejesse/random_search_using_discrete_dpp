Packaging and Deploying DPP_Sampler
...
2. Installing the DPP_Sampler Package

A. Go to the directory that contains the file setup.py and the subdirectory DPP_Sampler. 
...
3. Using the DPP_Sampler Package

The DPP_Sampler package is on your Python path. To import it into a Python script or 
